...
export default function Page() {
  return (
    <main>
      ...
      <ArticleProse>
        <p>
          Planificar la vuelta de reparto todas las mañanas de forma manual —a criterio del chofer, con una lista de
          pedidos y el conocimiento acumulado de la zona— funciona hasta que dos o tres clientes tienen ventanas
          horarias que se superponen entre sí. Ahí aparece el problema real de cualquier distribuidora: no alcanza
          con encontrar el camino más corto, hay que respetar el horario en el que cada cliente puede recibir la
          entrega, sin dejar a nadie afuera ni hacer esperar al camión. A esto se suma que el combustible viene
          subiendo con fuerza: según la{' '}
          ...
          años— empujados principalmente por el combustible. Cada recorrido adicional, cada vuelta mal coordinada,
          representa un costo mayor que antes.
        </p>

        <h2>Qué es la "ventana horaria" y por qué complica una planificación manual</h2>
        <p>
          La ventana horaria es, simplemente, el rango de tiempo en el que un cliente puede recibir su pedido —
          porque abre a determinada hora, porque tiene su propio delivery que coordinar, o porque no tiene a nadie
          que reciba mercadería fuera de ese horario. Cuando la ruta se planifica sin herramientas automatizadas, es
          fácil perder de vista estas restricciones y terminar armando un recorrido que, aunque parezca lógico en el
          mapa, obliga al camión a esperar en un lugar o a volver más tarde a otro. Cada una de esas ineficiencias
          representa tiempo y combustible que se podrían haber evitado.
        </p>
        ...
        <h2>Qué cambia al planificar rutas con IA en lugar de hacerlo manualmente</h2>
        <p>
