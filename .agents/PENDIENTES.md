...
- **Crunchbase** (crunchbase.com) — cuenta gratuita, sin verificación física. Categorías: Artificial Intelligence, SaaS, Enterprise Software. Ubicación: Buenos Aires, Argentina (genérico, sin especificar Vicente López).
  ...
  - **Estado (2026-07-23) — intento de carga real, sigue fallando:** Imanol cargó Founders (Imanol + Felipe) y probó tocar Headquarters/Location al mismo tiempo. Al enviar, Crunchbase tira un error genérico ("There are errors in the edits you are trying to submit") sin marcar el campo puntual — bug conocido de la plataforma, no un dato mal cargado. Se aisló el problema: **el campo Headquarters exige una dirección postal completa** (Address Line, Postal Code), no acepta una ciudad genérica sola — por eso al intentar poner solo "Buenos Aires" sin calle, falla. Además quedó una entidad de Location huérfana ("Vicente López") con la dirección vieja (Roca 2253) enredada en el medio. **Decisión de Imanol: dejarlo tal cual está ahora (sin forzar más cambios) y pausar** — no vale la pena seguir peleando contra el bug hoy.
  - **Para retomar más adelante:** no tocar el campo Headquarters (dejarlo con la dirección vieja o vacío, no es un dato que se muestre como prioritario). Cargar/guardar únicamente Founders, Founded Date, Number of Employees y Full Description por separado, de a un campo por vez, sin mezclarlos con Headquarters/Location en el mismo submit — eso es lo que rompe el guardado.
...
- **Descripción larga — versión con nombres de clientes** (usada como base, con clientes reales mencionados; NO usar en Crunchbase por pedido de Imanol, sirve de referencia/para otros usos): "Dataria arma módulos de inteligencia artificial a medida para pymes y autónomos argentinos, organizados por industria: cálculo de food cost y gestión de reseñas para gastronomía, optimización de rutas y predicción de demanda para distribuidoras, CRM y agente de consultas por WhatsApp para inmobiliarias, y control de stock y proyecciones de ventas para e-commerce. A diferencia de una consultora que parte de cero, cada módulo ya está construido y se puede probar en vivo en la web antes de contratar nada. Dataria se encarga de toda la integración y capacitación — el cliente no necesita programar ni tener equipo técnico propio. Se empieza con un módulo y se crece sin rehacer lo ya implementado. Ya lo usan negocios reales como Ragú, Padella, Pastas Pariggi, Pollo Cocido y MP Catering."
- **Descripción larga — versión SIN nombres de clientes** (usar en Crunchbase "Full Description" y en AlternativeTo/Toolify): "Dataria arma módulos de inteligencia artificial a medida para pymes y autónomos argentinos, organizados por industria: cálculo de food cost y gestión de reseñas para gastronomía, optimización de rutas y predicción de demanda para distribuidoras, CRM y agente de consultas por WhatsApp para inmobiliarias, y control de stock y proyecciones de ventas para e-commerce. A diferencia de una consultora que parte de cero, cada módulo ya está construido y se puede probar en vivo en la web antes de contratar nada. Dataria se encarga de toda la integración y capacitación — el cliente no necesita programar ni tener equipo técnico propio. Se empieza con un módulo y se crece sin rehacer lo ya implementado. Agendá una consulta gratuita de 15 minutos."
